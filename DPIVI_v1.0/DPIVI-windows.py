...
# This source is compatible with windows systems
import os
import sys
import time
...
print(""" 
  ...
  [+] Written by: KsrvcO
  [+] Contact me: flower.k2000[at]gmail.com
  [+] Compatible with: Windows Operation Systems
...
if choo == 1:
    dir = raw_input("  [-] Enter your database directory : ")
    samplepic = raw_input("  [-] Enter your picture for identity : ")
    print("""
      **************************************
	...
	os.system('powershell.exe Set-ExecutionPolicy RemoteSigned -force')
	os.system('powershell.exe [Get-ChildItem outfolder\ -file -Recurse -Exclude *.jpg | Remove-Item -Force]')
elif choo == 3:
    os.system("exit")
else:
